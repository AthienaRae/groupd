    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 8, letterSpacing: 0.5, textTransform: 'uppercase' }}>
                Email
              </label>
              <input
                type="email"
        ...
        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>
          ...
          <Link to="/register" style={{ color: '#F2C4CD', textDecoration: 'none' }}>Register</Link>
        </p>
      </div>
    </div>
  )
